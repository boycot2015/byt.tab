...
function WidgetModal(props: {
  ...
  const onRefresh = () => {
    ...
    getWeather(currentWeather.location.city).then((res) => {
      setWeathers(
        [res, ...weathers].filter(
          (el, index, self) =>
            self.findIndex(
                          ...
                          <div className="flex flex-col items-center justify-center gap-2 hover:bg-white/30 p-2 hover:!rounded-xl">
                            ...
                            <div className="flex gap-1 justify-center items-center">
                              <span
                                dangerouslySetInnerHTML={{
                                  __html:
                                    weatherIcon[el.day_condition] || 'sunny'
                                }}></span>
                      ...
                      {currentWeather?.daily_forecast?.length ? (
                        <div className="absolute left-0 bottom-[70px] w-full">
                          <DailyChart
                            ...
                            data={currentWeather?.daily_forecast?.map(
                              (item) => ({
                                datetime:
                          ...
                          <span
                            dangerouslySetInnerHTML={{
                              __html: item?.weather?.condition
                                ? weatherIcon[item?.weather?.condition] ||
                                  'sunny'
                                : 'sunny'
                            }}></span>
